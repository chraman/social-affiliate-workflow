...
const workflowTemplate = require('./wan-i2v-fun-animate-workflow.json');
...
async function startImageToVideoUsingComfyUI(imageUrl, userPrompt) {
 ...
 let controlVideoUrl = "https://res.cloudinary.com/ds8bfxetq/video/upload/v1788866572/igexport-db0o-6kt9be_eOV3ncvz_aaff6z.mp4"
...
userPrompt = "Photorealistic RAW video, 35mm lens, natural daylight, soft subsurface scattering, realistic skin and fur texture, realistic ambient lighting, cinematic shadows, 24fps motion blur."
  if (userPrompt) {
